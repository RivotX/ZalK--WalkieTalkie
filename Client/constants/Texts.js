...
export const Texts = {
  en: {
    ...
    ResetPasswordSuccess: 'An email with your new password has been sent to your email address.',
  ...
  es: {
    ...
    ResetPasswordSuccess: 'Se ha mandado un correo con tu contraseña a tu dirección de correo.',
    ResetPasswordError: 'No se ha podido enviar el correo, por favor, inténtalo de nuevo.',
    ResetPasswordSuccessTitle: 'Correo enviado',
