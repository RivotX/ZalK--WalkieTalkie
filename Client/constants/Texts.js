...
export const Texts = {
  en: {
    ...
    RememberPasswordText: 'Enter the email associated with your account.',
    RememberPasswordText2: 'You will receive an email with the password.',
    EmailPlaceholder: 'Enter an email',
    RememberPasswordSuccess: 'An email with your password has been sent to: ',
    RememberPasswordError: 'Could not send email, please try again.',
    RememberPasswordSuccessTitle: 'Email sent',
    RememberPasswordFailedTitle: 'Error sending email',
  ...
  es: {
    ...
    RememberPasswordText: 'Introduce el correo electrónico asociado a tu cuenta.',
    RememberPasswordText2: 'Recibirás un correo con tu contraseña.',
    EmailPlaceholder: 'Introduce un correo electrónico',
    RememberPasswordSuccess: 'Se ha mandado un correo con tu contraseña a: ',
    RememberPasswordError: 'No se ha podido enviar el correo, por favor, inténtalo de nuevo.',
    RememberPasswordSuccessTitle: 'Correo enviado',
    RememberPasswordFailedTitle: 'Error al enviar correo',
