...
const initialRooms = [
  ...
  { name: 'El Panal Zumbante', info: 'Una colmena de conversaciones zumbantes.' },
  { name: 'Café Conversador', info: 'Toma un café y charla sin parar.' },
  { name: 'Amigos en Frecuencia', info: 'Sintoniza con amigos en la misma frecuencia.' },
  { name: 'El Centro Social', info: 'El centro de todas las interacciones sociales.' },
  { name: 'Base de Ecos', info: 'Una base para pensamientos e ideas resonantes.' },
  { name: 'Rebeldes de la Radio', info: 'Rebélate contra el silencio con ondas de radio.' },
  { name: 'Loud & Clear', info: 'Make your voice heard loud and clear.' },
  { name: 'Guerreros de la Frecuencia', info: 'Guerreros en la misma frecuencia.' },
  { name: 'Chit Chat Lounge', info: 'Lounge around and chit chat.' },
  { name: 'La Sala del Pulso', info: 'Siente el pulso de la conversación.' },
  { name: 'Esquina de Conexión', info: 'Conéctate con otros en esta esquina.' },
  { name: 'Estación de Señales', info: 'Envía y recibe señales de comunicación.' },
  { name: 'La Caja de Bromas', info: 'Una caja llena de bromas amistosas.' },
  { name: 'La Cubierta de Conversación', info: 'Equipado para todas tus necesidades de conversación.' },
  { name: 'Callejón de Ondas', info: 'Un callejón de ondas y conversaciones.' },
  { name: 'Circuito de Chat', info: 'Completa el circuito con tus chats.' },
  { name: 'SpeakEasy Lounge', info: 'Speak easy and relax in this lounge.' },
  { name: 'Refugio de Armonía', info: 'Un refugio para conversaciones armoniosas.' },
  { name: 'La Zona de Charla', info: 'Entra en la zona de charla interminable.' },
  { name: 'El Club de Conversación', info: 'Únete al club y empieza a conversar.' },
  { name: 'Frecuencias Infinitas', info: 'Frecuencias infinitas para charlas infinitas.' },
  { name: 'Plaza WalkieTalkie', info: 'Una plaza para los entusiastas del walkie-talkie.' },
  { name: 'Ciudad de la Charla', info: 'Una ciudad donde la charla nunca se detiene.' },
  { name: 'Café de Enlace', info: 'Conéctate y comunica con un café.' },
  { name: 'Nido de Ruido', info: 'Un nido de ruido y discusiones animadas.' },
  { name: 'Vórtice Vocal', info: 'Déjate atrapar por el vórtice de voces.' },
  { name: 'Mesa Redonda de Radio', info: 'Una mesa redonda para discusiones de radio.' },
  { name: 'El Salón del Eco', info: 'Relájate y escucha los ecos.' },
  { name: 'La Bóveda de Voz', info: 'Guarda tu voz en este lugar seguro.' },
  { name: 'Cámara de Charla', info: 'Una cámara para charlas interminables.' },
  { name: 'El Lugar de Hablar', info: 'El lugar para todas tus necesidades de hablar.' },
  { name: 'Túnel de Conversación', info: 'Un túnel de charla continua.' },
  { name: 'El Centro de Sonido', info: 'El centro de todas las actividades relacionadas con el sonido.' },
  { name: 'Valle Vocal', info: 'Un valle lleno de expresiones vocales.' },
  { name: 'Taller de Ondas', info: 'Trabaja tus ideas en forma de onda.' },
  { name: 'Maestros del Micrófono', info: 'Los maestros del micrófono se reúnen aquí.' },
  { name: 'Hablar Juntos', info: 'Juntos hablamos y compartimos.' },
  { name: 'Sala de Resonancia', info: 'Una sala donde tu voz resuena.' },
  { name: 'Búnker de Transmisión', info: 'Un búnker para transmitir tus pensamientos.' },
  { name: 'El Garaje de Charla', info: 'Un garaje lleno de charla y conversación.' },
  { name: 'La Cabaña de Señales', info: 'Una cabaña para enviar y recibir señales.' },
  { name: 'La Sala de Ondas', info: 'Surfea las ondas de la conversación.' },
  { name: 'Cueva de Charla', info: 'Una cueva para todas tus necesidades de charla.' },
  { name: 'Taberna de Transmisión', info: 'Transmite tus pensamientos en esta taberna.' },
  { name: 'Rancho de Radio', info: 'Un rancho para los entusiastas de la radio.' },
  { name: 'La Guarida del Dial', info: 'Sintoniza las conversaciones en esta guarida.' },
  { name: 'La Torre de Hablar', info: 'Domina las conversaciones aquí.' },
  { name: 'Escape de Ecos', info: 'Escapa en los ecos de las voces.' },
  { name: 'Comuna de Charla', info: 'Una comuna para los amantes de la charla.' },
  { name: 'Terminal de Transmisión', info: 'Terminal para todas tus transmisiones.' },
  { name: 'La Voz en Off', info: 'Expresa tus pensamientos aquí.' },
  { name: 'El Mundo Walkie', info: 'Un mundo para los usuarios de walkie-talkie.' },
  { name: 'Tripulación de Chatterbox', info: 'Únete a la tripulación de chatterboxes.' },
  { name: 'Salón de Vibraciones', info: 'Relájate y capta las vibraciones.' },
  { name: 'Refugio de Radio', info: 'Un refugio para conversaciones de radio.' },
  { name: 'Sala de Zumbido', info: 'Una sala llena de actividad.' },
  { name: 'Templo de Conversación', info: 'Un templo dedicado a hablar.' },
  { name: 'Enclave de Ecos', info: 'Un enclave para voces resonantes.' },
  { name: 'Estación de Conversación', info: 'Estación para todas tus conversaciones.' },
  { name: 'Estación de Transmisión', info: 'Estación para transmitir tus pensamientos.' },
  { name: 'Terraza de Ondas', info: 'Terraza para los entusiastas de las ondas.' },
  { name: 'La Esfera Sónica', info: 'Una esfera de discusiones sónicas.' },
  { name: 'La Bóveda de Voz', info: 'Guarda tu voz de manera segura aquí.' },
];
